...
The initial public repository commit was published on 11 July 2026:

https://github.com/willproudler/care-library/commit/12bc7b1de80ec73976865c0c088f4940da8f36a7

When relying on a specific defensive-publication statement, cite:

- the exact document title;
- the document version;
- the relevant commit or future release tag;
- the public URL;
...
## Withdrawn working material

Files removed from the current branch—including working drafts, private inventory metadata and incomplete examples—are not part of the proposed v0.1.0 release package.
